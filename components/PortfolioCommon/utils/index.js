...
export const filterWorks = (works, { workType = DEFAULT_WORK_TYPE, tags: selectedTags = [] }) => works.filter(({ tags, types }) => {
  const castedSelectedTags = selectedTags.map(slugMapper);
