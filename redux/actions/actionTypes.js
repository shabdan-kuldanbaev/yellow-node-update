export const actionTypes = {
  ...
  /* ------------------------ */
  FETCH_ARTICLE_DATA_PENDING: 'layout/FETCH_ARTICLE_DATA_PENDING',
  /* ------------------------ */
  PAGE_READY_TO_DISPLAY_PENDING: 'layout/PAGE_READY_TO_DISPLAY_PENDING',
  PAGE_READY_TO_DISPLAY_SUCCESS: 'layout/PAGE_READY_TO_DISPLAY_SUCCESS',
  PAGE_READY_TO_DISPLAY_FAILED: 'layout/PAGE_READY_TO_DISPLAY_FAILED',
  /* ------------------------ */
