...
const getServiceMicrodata = (page) => ({
  '@context': context,
  '@type': 'Service',
  ...
  availableChannel: getServiceChannel(pageUrl(page.path)),
  areaServed: getPlace(addresses),
  serviceOutput: getServiceOutput(page.title),
  hasOfferCatalog: getOfferCatalog(page.title, OFFERS[page.slug]),
});
...
export const microdata = {
  ...
  customChatApp: () => ([
    websiteMicrodata,
    organisationMicrodata,
    getServiceMicrodata(ROUTES.customChatApp),
  ]),
  penetrationTesting: () => ({
    '@context': context,
    '@type': 'WebPage',
  ...
  erpDevelopment: () => ([
    websiteMicrodata,
    organisationMicrodata,
    getServiceMicrodata(ROUTES.erpDevelopment),
  ]),
  designServices: () => ({
    '@context': context,
    '@type': 'WebPage',
  ...
  mlDevelopment: () => ([
    websiteMicrodata,
    organisationMicrodata,
    getServiceMicrodata(ROUTES.mlDevelopment),
  ]),
  devOpsDevelopment: () => ({
    '@context': context,
    '@type': 'WebPage',
  ...
  aiDevelopment: () => ([
    websiteMicrodata,
    organisationMicrodata,
    getServiceMicrodata(ROUTES.aiDevelopment),
  ]),
  ...
  dataScienceDevelopment: () => ([
    websiteMicrodata,
    organisationMicrodata,
    getServiceMicrodata(ROUTES.dataScienceDevelopment),
  ]),
